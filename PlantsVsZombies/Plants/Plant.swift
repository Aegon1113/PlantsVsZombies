...
class Squash:SKSpriteNode{
    ...
    func Action(){
        ...
        for i in 1...dbAtlas.textureNames.count-1 {
            ...
            tempName = String(format:fileName+"%d",i)
            let dbTexture = dbAtlas.textureNamed(tempName)
            dbFrames.append( dbTexture )
        }
        ...
        */
        self.run(SKAction.repeatForever(
            SKAction.animate(with:dbFrames, timePerFrame: 10)))
...
class Squash:SKSpriteNode{
    ...
    func Action(){
        ...
        for i in 1...dbAtlas.textureNames.count-1 {
            ...
            tempName = String(format:"Spuash"+"%d",i)
            let dbTexture = dbAtlas.textureNamed(tempName)
            dbFrames.append( dbTexture )
        }
        self.run(SKAction.repeatForever(
...
class SquashAttack:SKSpriteNode{
    private var plantHp:Int
    private var plantCost:Int
    private var fileName:String
    private var haveZombie:Bool
    ...
    func Action(){
        ...
        for i in 1...dbAtlas.textureNames.count-1 {
            ...
            tempName = String(format:"Frame"+"%d",i)
            let dbTexture = dbAtlas.textureNamed(tempName)
            dbFrames.append( dbTexture )
        }
        //self.run(SKAction.repeatForever(SKAction.animate(with:dbFrames, timePerFrame: 0.2)))
        self.run(
            SKAction.animate(with:dbFrames, timePerFrame: 0.5))
